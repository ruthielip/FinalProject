...
const Profile = () => {
  ...
  useEffect(()=>{
    const getFollowers = async ()=>{
      try{
        const followersList = await axiosInstance.get(`/users/followers/${user._id}`)
  ...
  const updateProfilePic = async (e) => {
    ...
    try {
      await axiosInstance.put(`/users/${user._id}`, newProfilePic);
  ...
  const updateCoverPic = async (e) => {
    ...
    try {
      await axiosInstance.put(`/users/${user._id}`, newCoverPic);
      window.location.reload();
    } catch(err) {
      console.log(err);
    }
  ...
  const editDesc = async (e) => {
    ...
    try {
      await axiosInstance.put(`/users/${user._id}`, newDesc);
      window.location.reload();
    } catch(err) {
      console.log(err);
    }
